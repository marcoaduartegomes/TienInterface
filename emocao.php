...
<div style="text-align: center;">
            <button data-toggle="modal" data-target="#Cadastrar" id="slider" class="btn btn-lg BotaoCadastra">Cadastrar Emoção</button>
        </div>
</div> 
...
<table  class="table table-striped table-dark table-hover " style="width:1000px;" id="tb1">
    ...
    <tbody>
        ...
        foreach($rows as $row){ 
            ...
            echo '<td>'.$codEstatus.'</td>';
            echo '<td>'.$nome.'</td>';
            echo '<td><button class="btn Botao" data-toggle="modal" id="deletaSlide" data-target="#Excluir" value="'.$codEstatus.'" type="button">Excluir</button>';
            echo '</tr>';
        }
        ?>
    </tbody>
...
<div  class="modal" id="Cadastrar" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color:rgb(99,00,33);">
                <h5 class="modal-title" style="color:white;">Cadastramento de emoção?</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="container">
					...
					<div class="form-group">
                                        <label for="nomeEmocao">Nome</label>
                                        <input type="text" name="nomeEmocao" id="nomeEmocao" required  class="form-control"/>
                                  </div>                   
                                  <div>
...
<script src="Javascript/emotes.js"></script>
